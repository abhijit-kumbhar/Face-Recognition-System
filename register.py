...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\abhij\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        loginbtn=Button(frame,command=self.root,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
