...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\abhij\Documents\Python_Test_Projects\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"C:\Users\abhij\Documents\Python_Test_Projects\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\abhij\Documents\Python_Test_Projects\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\abhij\Documents\Python_Test_Projects\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "http://vpasccollege.edu.in/"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/vpsascsupe/"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/watch?v=I7x6f-FxZuo"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "vpasc_college@yahoo.co.in"
        webbrowser.open(self.url,new=self.new)
